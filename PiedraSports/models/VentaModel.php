...
class VentaModel
{
    ...
    public function setVenta($precioTotal, $precioUnitario, $cantidadProducto, $formaDePago, $fecha, $predido, $empleado)
    {
        $stmt = $this->pdo->prepare("INSERT INTO ventas VALUES(null, :precioTotal, :precioUnitario, :cantidadProducto, :formaDePago, :fecha, :peedido, :empleado)");
