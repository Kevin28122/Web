...
class VentaController
{
    ...
    public function setVenta($precioTotal, $precioUnitario, $cantidadProducto, $formaDePago, $fecha, $pedido, $empleado)
    {
        if($precioTotal == null || $precioUnitario == null || $cantidadProducto == null || $formaDePago == null || $fecha = null || $pedido ==null || $empleado == null) {
            echo'
            ...
            $this->model->setVenta($precioTotal, $precioUnitario, $cantidadProducto, $formaDePago, $fecha, $pedido, $empleado);
            echo'
